  ...
  return (
    <div className="max-w-screen-xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row  space-x-5 ">
        {productList ? (
          <>
            <div className="w-[715px] flex flex-row md:flex-col items-start px-[24px] py-[20px] border border-[#0000001a] rounded-[20px] space-y-4">
                      ...
                      <div className="flex flex-col justify-between items-end">
                        ...
                        <div className="w-[126px] h-[44px] flex justify-between items-center bg-[#F0F0F0] rounded-[62px] px-[20px] py-[16px]">
                          <button
                            ...
                            title="Azalt"
                            onClick={() =>
                              handleDecreaseNumberProduct(product.id)
                            }
                          >
                            -
                          </button>
                          ...
                          <button
                            ...
                            title="Arrtır"
                            onClick={() =>
                              handleIncreaseNumberProduct(product.id)
                            }
                          >
                            +
                          </button>
            ...
            <div className="w-[505px] h-[458px] flex flex-row md:flex-col items-start px-[24px] py-[20px] border border-[#0000001a] rounded-[20px] space-y-4 ">
